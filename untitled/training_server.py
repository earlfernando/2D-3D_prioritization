...
def random_forest_chunks(headers, feature_length, csv_file_location, file_name):
    ...
    chunk_size = 10**4
    counter = 0
    clf = RandomForestClassifier(n_estimators=100,warm_start=True,max_features= 100,n_jobs=-1,max_depth= 300,min_samples_split=100,min_samples_leaf=200,oob_score= True)
