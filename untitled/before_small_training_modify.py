...
import matplotlib.pyplot as plt
import  numpy as np
negatve = [     0. ,     0.    ,  0.    ,  0.     , 0. ,391029., 112537.  , 1622. ,     0.,
      0.  ,    0.]
positve =[0.00000e+00,0.00000e+00, 0.00000e+00, 0.00000e+00, 0.00000e+00, 1.88228e+05,
 2.58149e+05, 4.19730e+04, 8.78000e+02, 4.40000e+01, 2.00000e+00]
c =[0.00000e+00, 0.00000e+00, 0.00000e+00, 7.51000e+02, 3.67550e+04, 3.03977e+05,
 2.58149e+05, 4.19730e+04, 8.78000e+02, 4.40000e+01, 2.00000e+00]
b =[9.960000e+02, 3.181000e+03, 2.275000e+04, 2.470580e+05, 8.771630e+05,
 1.037301e+06, 1.125370e+05, 1.622000e+03, 0.000000e+00 ,0.000000e+00,
 0.000000e+00]
accuracy_negative = []
accuracy_positve = []
...
for i in range(11):
    if positve[i]:
        accuracy_positve.append(positve[i] / c[i])
    else:
        accuracy_positve.append(0)
    if negatve[i] > 0:
        accuracy_negative.append(negatve[i] / b[i])
    else:
        accuracy_negative.append(0)
print(accuracy_positve,accuracy_negative)
x_axis = np.arange(11)
x_axis = x_axis / 10
fig, ax = plt.subplots()
line = ax.plot(x_axis, accuracy_positve[0:11], label='positve')
line2 = ax.plot(x_axis, accuracy_negative[0:11], label='negative')
ax.legend()
plt.xlabel('probability from random forest')
