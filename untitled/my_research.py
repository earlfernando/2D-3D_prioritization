...
save_location_overall = "/home/earlfernando/kingscollege/dataset_full/"
...
csv_file_location_400000 = "/home/earlfernando/kingsollege/training_Data_RandomForest_overall.csv"
...
location_small_dataset = "/home/earlfernando/kingscollege/train_forest_small.csv"
...
def random_forest_chunks(headers, feature_length, csv_file_location, file_name, n, max_dept, min, save_location_forest,
                         feature_mode, location_small_dataset):
    # df = pd.DataFrame.from_records(values, columns=headers)
    chunk_size = 10 ** 4
    counter = 0
    ...
    clf = RandomForestClassifier(n_estimators=n, warm_start=True, max_features=None, n_jobs=-1, max_depth=max_dept,
                                 min_samples_leaf=min, class_weight="balanced",
    ...
    for n in N:
        for max_dept in max_depth:
            for min in min_leaf_nodes:
                ...
                save_location_local = save_location + 'N=' + str(n) + 'max_depth=' + str(max_dept) + 'min_leaf=' + str(
                    min)
                ...
                accuracy, local_time = prediction_forest(headers, feature_length, csv_file_location_kmeans_test,
                                                         ...
                                                         n=n, max_dept=max_dept, min=min,
                                                         save_location_picture=save_location_picture)
